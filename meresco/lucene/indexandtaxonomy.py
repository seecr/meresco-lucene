...
class IndexAndTaxonomy(object):
    ...
    def __init__(self, indexWriter=None, taxoWriter=None, similarity=None, executor=None):
        ...
        self.searcher = SuperIndexSearcher(reader, executor) if self._excexutor else IndexSearcher(reader)
    ...
    def reopen(self):
        ...
        if reader is None:
            return
        currentReader.close()
        self.searcher = SuperIndexSearcher(reader, self._excexutor) if self._excexutor else IndexSearcher(reader)
