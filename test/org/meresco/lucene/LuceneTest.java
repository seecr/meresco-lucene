...
public class LuceneTest extends SeecrTestCase {
    ...
    public void testSorting() throws Exception {
        ...
        LuceneResponse result = lucene.executeQuery(new MatchAllDocsQuery(), 0, 10, sort, null, null, null, null);
        assertEquals(3, result.total);
        ...
        result = lucene.executeQuery(new MatchAllDocsQuery(), 0, 10, sort, null, null, null, null);
        assertEquals(3, result.total);
    ...
    public void testStartStop() throws Exception {
        ...
        result = lucene.executeQuery(new MatchAllDocsQuery(), 1, 10, null, null, null, null, null);
        assertEquals(3, result.total);
        assertEquals(2, result.hits.size());
        result = lucene.executeQuery(new MatchAllDocsQuery(), 0, 2, null, null, null, null, null);
        assertEquals(3, result.total);
        assertEquals(2, result.hits.size());
        result = lucene.executeQuery(new MatchAllDocsQuery(), 2, 2, null, null, null, null, null);
        assertEquals(3, result.total);
        assertEquals(0, result.hits.size());
        result = lucene.executeQuery(new MatchAllDocsQuery(), 1, 2, null, null, null, null, null);
        assertEquals(3, result.total);
        assertEquals(1, result.hits.size());
        result = lucene.executeQuery(new MatchAllDocsQuery(), 0, 0, null, null, null, null, null);
        assertEquals(3, result.total);
        assertEquals(0, result.hits.size());
    }
    ...
    public void testQueryWithFilter() throws Exception {
        ...
        assertEquals(2, lucene.executeQuery(new MatchAllDocsQuery(), 0, 0, null, null, null, null, null).total);
        final Filter f = new QueryWrapperFilter(new TermQuery(new Term("field1", "value1")));
        assertEquals(1, lucene.executeQuery(new MatchAllDocsQuery(), 0, 0, null, null, new ArrayList<Filter>() {{ add(f); }}, null, null).total);
    }
    ...
    public void testQueryWithKeyCollectors() throws Exception {
        ...
        assertEquals(2, lucene.executeQuery(new MatchAllDocsQuery(), 0, 0, null, null, null, new ArrayList<KeySuperCollector>() {{ add(k); }}, null).total);
        ...
        assertEquals(1, lucene.executeQuery(field0Query, 0, 0, null, null, null, new ArrayList<KeySuperCollector>() {{ add(k1); }}, null).total);
